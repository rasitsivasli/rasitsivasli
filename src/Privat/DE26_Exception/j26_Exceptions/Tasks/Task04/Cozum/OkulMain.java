...
public class OkulMain {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < okul1.getMaxOgrSayisi(); i++) {
            ...
            Ogrenci.ogrenciList.add(ogrenci);
        }
        Okul okul = new Okul(okul1.getOkulAd(), okul1.getMaxOgrSayisi(), Ogrenci.ogrenciList);
        Okul.okulList.add(okul);

        System.out.println(Okul.okulList.toString()); // okul listini, içindeki ogrenci listi ile beraber yazdırır.
    }
}
